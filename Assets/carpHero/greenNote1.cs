...
public class greenNote1 : MonoBehaviour
{
    ...
    void Start()
    {
        noteStartPos = GameObject.FindWithTag("greenNoteStartPos1");
        noteEndPos = GameObject.FindWithTag("greenNoteEndPos1");
        noteGoal = GameObject.FindWithTag("greenNoteGoal");
